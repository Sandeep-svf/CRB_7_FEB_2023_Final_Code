...
//                verifyCode(code);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Add galary camera code for select user proifle photo during sign up
    /*   addUserProfileSignup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Dialog addProfileDialog = new Dialog(SignupActivity.this);
                addProfileDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
                addProfileDialog.setContentView(R.layout.add_profile_dialog);
                TextView gallaryDialog = addProfileDialog.findViewById(R.id.gallaryDialog);
                TextView cameraDialog = addProfileDialog.findViewById(R.id.cameraDialog);

                addProfileDialog.show();
                Window window = addProfileDialog.getWindow();
                    ...
                    public void onClick(View v) {
                        ...
                        if (readExternal && camera  &&  writeExternal) {
                            if (packageManager.hasSystemFeature(PackageManager.FEATURE_CAMERA)) {
                                ...
                                values3.put(MediaStore.Images.Media.TITLE, "New Picture");
        ...
        // Add galary plus camera code to upload user id suring signup
      /*  uoploadIDAddButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Dialog addIDDialog = new Dialog(SignupActivity.this);
                addIDDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
                addIDDialog.setContentView(R.layout.add_id_dialog);
                TextView gallaryDialog = addIDDialog.findViewById(R.id.gallaryDialog);
                TextView cameraDialog = addIDDialog.findViewById(R.id.cameraDialog);

                addIDDialog.show();
                Window window = addIDDialog.getWindow();
                window.setLayout(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
                    ...
                    public void onClick(View v) {
                        ...
                        if (readExternal && camera && writeExternal) {
                            if (packageManager.hasSystemFeature(PackageManager.FEATURE_CAMERA)) {
                                ...
                                values4.put(MediaStore.Images.Media.TITLE, "New Picture");
                                values4.put(MediaStore.Images.Media.DESCRIPTION, "From your Camera");
                                imageUri4 = getContentResolver().insert(
                                        MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values4);
                                Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        ...
        signupHomeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }else if(userMobileNumber.getText().toString().length() < 1 ||
                         userMobileNumber.getText().toString().length() > 18){
                    userMobileNumber.setError("Please enter valid phone number");
                    userMobileNumber.requestFocus();
...
//                    String countryCode = userMobileData.substring(0,3);
//                    String zero = userMobileData.substring(0,1);
//
//                    if(zero.equals("0"))
//                    {
//                        //  String tempString = strEmail.substring(1, strEmail.length());
//                        newPhoneNumber = userMobileData.substring(1,userMobileData.length());
//
//                    }


                    // sendVerificationCode("+91" + userMobileData);
                /*      Dialog otpDialog = new Dialog(SignupActivity.this);
                    otpDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
                    otpDialog.setContentView(R.layout.otp_dialog);
                    LinearLayout verifyOtpLayout = otpDialog.findViewById(R.id.verifyOtpLayout);
                    ImageView closeVerifyDialog = otpDialog.findViewById(R.id.closeVerifyDialog);
                    EditText getOtpData = otpDialog.findViewById(R.id.getOtpData);
                  ...
                  otpDialog.show();
                    ...
                    verifyOtpLayout.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {

                            String optData = getOtpData.getText().toString();

                            if(optData.isEmpty())
                            {
                                Toast.makeText(SignupActivity.this, "Please insert OTP", Toast.LENGTH_SHORT).show();
                                return;
                            }else if(optData.length()!= 6)
                            {
                    ...
                    closeVerifyDialog.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            otpDialog.dismiss();
                        }
    ...
    nextbtn(View view) {
      ...
      //  Log.d("hgdfg", fbUserPhoneNumber+"ok");
       // Toast.makeText(SignupActivity.this, fbUserPhoneNumber+"#", Toast.LENGTH_SHORT).show();
